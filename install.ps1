$DOWNLOAD_CLI = "https://github.com/Julienraptor02/Installer/releases/latest/download/VencordInstallerCli.exe"
$DOWNLOAD_GUI = "https://github.com/Julienraptor02/Installer/releases/latest/download/VencordInstaller.exe"
